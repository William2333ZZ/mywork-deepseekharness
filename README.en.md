...
- Five functional micro-motions: the live-browser pane slides in, reminder toasts enter and leave, new-conversation cards lift on hover and their prompts stagger in, style / scheme switches cross-fade over 220ms, and a task's notification chip flashes once after saving. Transform and opacity only, 150–400ms, all off under prefers-reduced-motion.
